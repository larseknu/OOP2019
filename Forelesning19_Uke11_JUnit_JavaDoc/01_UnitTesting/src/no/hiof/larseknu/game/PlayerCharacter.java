...
public class PlayerCharacter {
    ...
    /**
     * Sets a default name for the PlayerCharacter, sets isNoob to true, level to 1 and generates a list of starting weapons.
     */
     ...
     */
    private ArrayList<String> createStartingWeapons() {
